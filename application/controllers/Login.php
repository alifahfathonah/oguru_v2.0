...
class Login extends CI_Controller {
    ...
    public function validate_login($perulangan = 0) {
       
        // $email = $this->input->post('email');
        // $password = $this->input->post('password');
        // $URL = site_url('login/validate_login/'.strval($email));
        
        // if($perulangan == 0){
        //     $this->session->set_userdata('l_email', $this->input->post('email'));
        //     $this->session->set_userdata('l_pass', $this->input->post('password'));
        //     $perulangan++;
        //     redirect(site_url('login/validate_login/').$perulangan, 'refresh');  
        ...
        // }else{
        //     die(site_url('login/validate_login/').$this->session->userdata('l_email').'/'.$perulangan);
        ...
        if ($query->num_rows() > 0) {
            ...
            if($row->status == 1){
                ...
                $this->session->set_userdata('is_edukator', $row->is_edukator);
