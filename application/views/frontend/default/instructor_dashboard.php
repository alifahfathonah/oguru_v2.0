        ...
        <div class="row">
            <div class="col">
                ...
                <ul>
                    ...
                    <li class="<?php if($type == 'pending') echo "active"; ?>"><a href="<?php echo site_url('home/dashboard/pending'); ?>"><?php echo get_phrase('pending_courses'); ?> ( <?php echo $my_courses['pending']->num_rows(); ?> )</a></li>s
