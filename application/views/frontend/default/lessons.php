...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-3">
            ...
            <?php 
                if($course_details['tipe'] == 'webinar'){ ?>
            <div class="accordion">
                    <div class="card" style="margin:10px 0px;">
                        <div class="card-header">

                            <h5 class="mb-4 text-center" style="color: #686f7a; font-size: 15px;">
                                Reminder Webinar
                            </h5>
                        </div>
                    </div>
                        ...
                        <div class="card-header" id="<?php echo 'heading-'.$section['id']; ?>">
                            ...
                            <h5 class="mb-0">
                                <button class="btn btn-link w-100 text-left" type="button" data-toggle="collapse" data-target="<?php echo '#collapse-'.$section['id']; ?>" aria-expanded="true" aria-controls="<?php echo 'collapse-'.$section['id']; ?>" style="color: #535a66; background: none; border: none; white-space: normal;">
                                    <h6 style="color: #686f7a; font-size: 15px;">Tahap <?php echo $section_counter;?></h6>
                                    ...
                                    <?php foreach ($lessons as $lesson): ?>
                                        ...
                                        <tr style="width: 100%; padding: 5px 0px;">
                                            <td style="text-align: left;padding:10px; border-bottom:1px solid #ccc;">
                                                <a href="<?php echo site_url('home/belajar/'.slugify($course_details['title']).'/'.$course_id.'/'.$lesson['id']); ?>" id = "<?php echo $lesson['id']; ?>">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Penting</h5>
                                <p class="card-text">Silahkan masuk kedalam grup chat berikut <a href="<?php echo $course_details['linkgrup']; ?>"><?php echo $course_details['linkgrup']; ?></a></p>
                                <i><p class="card-text">Link webinar akan disampaikan dalam grup tersebut.</p></i>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <?php else: ?>
                        <div class="mt-5">
                            <a href="<?php echo base_url().'uploads/lesson_files/'.$lesson_details['attachment']; ?>" class="btn btn-sign-up" download style="color: #fff;">
                                <i class="fa fa-download" style="font-size: 20px; color: blue"></i> <?php echo get_phrase('download').' '.$lesson_details['title']; ?>
                            </a>
                        </div>
                    <?php endif; ?>
                </div>
