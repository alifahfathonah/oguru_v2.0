<div class="row">
    <div class="col-lg-12">
        <div class="card text-white bg-quiz-result-info mb-3">
            <div class="card-body">
                <h5 class="card-title">Ulasan materi untuk memperluas pengetahuanmu.</h5>
                <p class="card-text">Kamu menjawab <?php echo $total_correct_answers; ?> dari <?php echo $total_questions; ?> benar.</p>
            </div>
        </div>
    </div>
</div>
