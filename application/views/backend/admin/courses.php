                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <small class="text-muted"><?php echo 'Edukator : <b>'.$instructor_details['first_name'].' '.$instructor_details['last_name'].'</b> ('.$instructor_details['status_edukator'].')'; ?></small>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <small class="text-muted"><?php echo str_replace("_"," ",$course['tipe']); ?></small><br>
                                    </td>
                                    <td>
