...
<div class="left-side-menu left-side-menu-detached">
	...
	<!--- Sidemenu -->
		<ul class="metismenu side-nav side-nav-light">
            ...
            <li class="side-nav-item">
				<a href="<?php echo site_url('admin/mitra'); ?>" class="side-nav-link <?php if ($page_name == 'mitra' || $page_name == 'mitra_add' || $page_name == 'mitra_edit')echo 'active';?>">
					<i class="dripicons-user-group"></i>
					<span>Mitra</span>
				</a>
			</li>
			<li class="side-nav-item <?php if ($page_name == 'edukator' || $page_name == 'konfirmasi_edukator' || $page_name == 'detail_pendaftar_edukator' ): ?> active <?php endif; ?>">
				<a href="javascript: void(0);" class="side-nav-link <?php if ($page_name == 'edukator' || $page_name == 'konfirmasi_edukator' || $page_name == 'detail_pendaftar_edukator'): ?> active <?php endif; ?>">
				...
				<ul class="side-nav-second-level" aria-expanded="false">
					...
					<li class = "<?php if($page_name == 'konfirmasi_edukator' || $page_name == 'detail_pendaftar_edukator') echo 'active'; ?>">
