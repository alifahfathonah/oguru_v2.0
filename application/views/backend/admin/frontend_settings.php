            ...
            <div class="card-body">
                ...
                <form class="required-form" action="<?php echo site_url('admin/frontend_settings/frontend_update'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="terms_and_condition" id ="terms_and_condition" class="form-control" rows="5"><?php echo get_frontend_settings('syarat_ketentuan'); ?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="kebijakan_privasi">Kebijakan Privasi</label>
                        <textarea name="kebijakan_privasi" id = "kebijakan_privasi" class="form-control" rows="5"><?php echo get_frontend_settings('kebijakan_privasi'); ?></textarea>
                    </div>

                    <div class="form-group">
                        <label for="bantuan">Bantuan</label>
                        <textarea name="bantuan" id = "bantuan" class="form-control" rows="5"><?php echo get_frontend_settings('bantuan'); ?></textarea>
                    </div>
                    
                    <div class="form-group">
                        <label for="informasi_edukator">Informasi Edukator</label>
                        <textarea name="informasi_edukator" id = "informasi_edukator" class="form-control" rows="5"><?php echo get_frontend_settings('informasi_edukator'); ?></textarea>
                    </div>
...
<script type="text/javascript">
  $(document).ready(function () {
    initSummerNote(['#informasi_edukator','#about_us', '#terms_and_condition', '#kebijakan_privasi', '#bantuan']);
  });
</script>
