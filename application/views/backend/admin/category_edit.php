          ...
          <form class="required-form" action="<?php echo site_url('admin/categories/edit/'.$category_id); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <select class="form-control select2" data-toggle="select2" name="parent" id="parent">
                ...
                <option value="1" <?php if($category_details['parent'] == 1) echo 'selected'; ?>>Vokasional</option>
                <option value="2" <?php if($category_details['parent'] == 2) echo 'selected'; ?>>Akademik</option>
                <option value="3" <?php if($category_details['parent'] == 3) echo 'selected'; ?>>Video</option>
              </select>
            </div>
