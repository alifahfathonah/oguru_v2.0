<?php
    $mitra_data = $this->db->get_where('mitra', array('id' => $mitra_id))->row_array();
?>
<div class="row ">
    <div class="col-xl-12">
        <div class="card">
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="header-title mb-3">Form Edit Mitra</h4>

                <form class="required-form" action="<?php echo site_url('admin/mitra/edit/'.$mitra_id); ?>" enctype="multipart/form-data" method="post">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" id="nama_mitra" name="nama_mitra" value="<?= $mitra_data['nama']?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="link">Link Mitra<span class="required">*</span></label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" id="link" value="<?= $mitra_data['link']?>" name="link" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <div class="d-flex">
                                                  <div class="">
                                                      <img class="mr-2" src="<?php echo $this->mitra_model->get_mitra_image_url($mitra_data['id']);?>" alt="" style="height: 50px; width: auto;">
                                                  </div>
